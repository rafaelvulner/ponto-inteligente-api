package com.ponto.pontointeligente.api.controller;
...
import com.ponto.pontointeligente.api.service.LancamentoService;
...
public class LancamentoControllerTest {
	...
	public void testCadastrarLancamento() throws Exception {
		...
		BDDMockito.given(this.funcionarioService.buscarPorId(Mockito.anyLong())).willReturn(Optional.ofNullable(new Funcionario()));
